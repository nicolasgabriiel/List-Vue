<template>
    <div class="mt-5     flex justify-between" v-bind:class="{ 'hide': invisivel }">
        <div class="flex">
            <div class="w-6 mr-2 border-2 border-black hover:cursor-pointer" @click="deixarMarcado"><img
